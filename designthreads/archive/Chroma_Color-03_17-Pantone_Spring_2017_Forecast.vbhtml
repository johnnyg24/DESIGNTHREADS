@Code
    PageData("Title") = "Chroma Color: Pantone Spring Forecast 2017"
    PageData("art_sub_title") = ""
    Layout = "~/designthreads/_DTLayout.vbhtml"
    PageData("description") = "Spring, a time of vitality and new life. "
End Code
