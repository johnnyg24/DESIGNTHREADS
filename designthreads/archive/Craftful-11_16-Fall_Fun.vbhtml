@Code
    PageData("Title") = "Craftful: Fall Fun"
    PageData("art_sub_title") = ""
    Layout = "~/_DTLayout.vbhtml"
    PageData("description") = "The season of cooking, baking, and celebrating has begun!"
End Code
...
<p>Savory suppers, sweet treats, and fall festivities are on everyone's mind. From tricksters to traditionalists, the season is full of joy for all. But let us not forget our homes! Add a little extra fall fun to your decor this year with something handmade. Crafted from the heart and with the hand, these little projects are sure to please. </p>

<p>Below you will find five festive fall fun crafts for you to conquer! Please click the photo for the link. And as always, if you have created any of these craftful ideas we would love to see them! Send images to HeatherS@estout.com. </p>
<div class="spacer"></div>
