...
<p>The concept of 'retro' decor has been quite popular for many years. It is hard to determine though, where the lines between Vintage, Mid-Century Modern and Retro meet. All three styles are completely separate in their methods, however they do have one thing in common: a love of design days of the past. To say your design is 'retro' is almost too vague, but it works in that it conjurs up any number of appropriate design styles. Spanning from the 50's through the 80's, 'retro' is full of spunk and optimism.</p>
<div class="spacer"></div>
