@Code
    PageData("Title") = "History of: Velvet"
    PageData("art_sub_title") = ""
    Layout = "~/_DTLayout.vbhtml"
    PageData("description") = "Sumptuous, sensually soft, and uncommonly sophisticated velvet boasts an exclusive history, filled with the richness of royalty."
End Code
...
<p>Before delving into the history of velvet, let's take a look at what it is exactly. The term 'velvet' actually describes the the structure of the fabric, not the fiber, like cotton or wool. Woven, not knit (that is known as velour), velvet is characterized by its pile- the raised loops or tufts of yarn it consists of. These tufts are perfectly distributed so as to give the fabric a short, dense pile which provides its distinctive look and feel. Velvet receives its trademark luster from the silk threads with which it is made. Traditionally made with silk, today velvet can be crafted from a variety of different fibers. Each results in a slightly different texture and sheen, as well as price, which allows everyone to afford this magnanimous textile. Woven on special looms that weaves two thicknesses at once, velvet is then cut apart to create its signature pile effect. This is quite the complicated process, which has been and continues to be the reason why high quality velvet is so costly. Due to this, back when velvet began its history, only the noble and wealthy were able to indulge in its luxury. </p>
<div class="spacer"></div>
