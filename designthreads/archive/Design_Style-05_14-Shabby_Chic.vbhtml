...
<div align="center"><a href="http://theoldpaintedcottage.com/pages/cotm-aug-2012.htm" target="_blank"><img class="img-responsive" alt="" style="width:500px; margin:auto" src="~/images/DesignStyle-ShabbyChic-DiningRoom.jpg"></a></div>
<div class="spacer"></div>
<hr />
...
<ul class="list-group no-side-border">
	<li class="list-group-item">1. Argento SC 'Spray' 4x4 Picture Frame</li>
	<li class="list-group-item">2. Simply Shabby Chic&reg; Heirloom White Comforter</li>
	<li class="list-group-item">3. Kichler Lighting 'Gracie' 8-Light Chandelier, Sunrise Mist </li>
	<li class="list-group-item">4. Floral Linen Cushion Cover, Turquoise</li>
	<li class="list-group-item">5. Newport Cottages Provence <a href="http://www.californiacozy.com/california-cozy-brands/newport-cottages/newport-cottages-provence-bookcase.html" target="_blank">Bookcase</a></li>
	<li class="list-group-item">6. Rachel Ashwell <a href="http://shabbychic.com/textiles/books-stationary/autographed-rachel-ashwell-shabby-chic-inspirations-beautiful-spaces.html#.U2EiW_ldWt8" target="_blank">"Shabby Chic Inspirations and Beautiful Spaces"</a> Book, Autographed</li>
	<li class="list-group-item">7. Slipcovered 'Rose' <a href="http://mossstudio.com/ProductDetail.aspx?pId=230" target="_blank">Chair</a></li>
</ul>
<div class="spacer"></div>
