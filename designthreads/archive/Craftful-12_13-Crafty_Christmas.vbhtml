@Code
    PageData("Title") = "Craftful: Crafty Christmas"
    PageData("art_sub_title") = ""
    Layout = "~/_DTLayout.vbhtml"
    PageData("description") = "The holidays are here and it's that time of year to fill your home with cheer."
End Code
...
<p>Whether you prefer traditional decor or something more simplistic, there is always something heartening about handmade decor and gifts. More meaningful than many of the alternatives, taking the time to craft something by hand truly helps embody the holiday spirit. With the rise in popularity of sites such as Pinterest, it is also becoming easier to find how to make some of those amazing items. A few minutes spent searching for any crafty idea will result in hundreds (if not thousands!) of how-to's. So take a moment and embrace your inner crafty self. 
</p>		
...
<p>Have a happy (hopefully crafty!) holiday. </p>
<div class="spacer"></div>
