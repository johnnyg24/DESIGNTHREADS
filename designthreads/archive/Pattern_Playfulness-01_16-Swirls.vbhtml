@Code
    PageData("Title") = "Pattern Playfulness: Swirls"
    PageData("art_sub_title") = ""
    Layout = "~/_DTLayout.vbhtml"
    PageData("description") = "Whimsical and wandering, this pattern is playfully sophisticated."
End Code
...
<p>Swirls have no definitive history to speak of. The term itself originated around the 15th century, although the design had unknowingly been around for ages. From fantastic to realistic motifs, the swirl fulfilled the need for a decorative accompaniment. With its random curving and twisting, the swirl pattern has come to define movement in a stationary form. To this day, swirls are frequently utilized to represent wind and movement. Its nonconformity allow it to pair nicely with many other pattern types, creating a unique overall design aesthetic. From abstract to purposeful, swirls are a unique way to add whimsy into any design. </p>
<div class="spacer"></div>
...
<p>Here is a variety of swirl patterns from Stout. </p>
<div class="spacer"></div>
