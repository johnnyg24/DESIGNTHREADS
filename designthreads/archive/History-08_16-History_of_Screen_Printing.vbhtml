@Code
    PageData("Title") = "History of: Screen Printing"
    PageData("art_sub_title") = ""
    Layout = "~/_DTLayout.vbhtml"
    PageData("description") = "The simple process of screen printing actually has quite the complex history."
End Code
...
<p>The waters are murky when it comes to the history of screen printing. Little is known for fact about when it began its story, though there are certainly pieces of evidence that prove it has been around for centuries- or longer. Getting its roots from the art of stenciling, screen printing has undergone a plethora of little nips and tucks. To truly explore all of its advancements would be a behemoth of a task, here you will find a simple outline of its history. </p>
<div class="spacer"></div>

<div align="center">
    <img class="img-responsive" alt="" src="~/designthreads/images/History-ScreenPrinting-SongDynasty.jpg">
    <div class="source-link">Example of printed currency from Song Dynasty</div>
</div>
<div class="spacer"></div>
