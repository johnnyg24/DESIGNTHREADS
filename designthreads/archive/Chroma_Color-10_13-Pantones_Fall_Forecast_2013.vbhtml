...
<p>While this may be mostly true, it seems that trends play a rather significant part of all aspects of design. None more so than the color forecasts from companies like Pantone. Setting the tone for our future, Pantone along with numerous other color driven companies, release forecasts for each season- usually near to a year in advance! The current forecast from Pantone includes its color of the year, Emerald along with ten other stunning shades. From sophisticated to lively, the prediction holds inspiration for all. </p>
<div class="spacer-1x"></div>

<p>Below are Stout's best representations of this season's forecast. </p>
<div class="spacer"></div>
