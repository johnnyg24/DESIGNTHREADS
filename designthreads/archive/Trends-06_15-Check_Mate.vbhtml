...
<p>Suitable in a variety of interiors, its simple repetition adds interest without becoming a distraction. Woven into proportional blocks of alternating color, buffalo check is traditionally red and black although now it is available in nearly any color combination. Similar to gingham, these checkered patterns differ only by the size of its squares; gingham is known for being a much smaller pattern with a repeat closer to ⅛ to ¼ of an inch, and the buffalo check is noticably larger starting its repeat at about 1.5 inches and growing. The geometric simplicity of buffalo check allows it to coordinate with a diverse selection of design styles. </p>
<div class="spacer"></div>
